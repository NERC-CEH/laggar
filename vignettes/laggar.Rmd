...
sum_within_dist(x = x, y = y, poly = poly, dist = 20)
...
# get number of points (number of trees?) within varying distances
points_parea <- lg_points(seedtraps, adults, 
                          dist_seq = dist_seq, poly = boundary)
## so this will need to change for a raster object...

# is this changing it to per hectare?
